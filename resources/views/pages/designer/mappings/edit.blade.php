@extends('layouts.app', ['title' => 'Edit mapping'])
...
@section('content')
    <section class="max-w-6xl mx-auto px-6 py-12">
        <x-layout.breadcrumbs :items="[
            ...
            ($mapping->design?->title ?? 'Mapping') => route('designer.mappings'),
            'Edit' => route('designer.mappings.edit', $mapping),
        ]" />

        <h1 class="heading-1 mb-8">Edit mapping<span class="text-coral-500">.</span></h1>
        ...
        <div class="grid md:grid-cols-[240px_1fr] gap-8">
            ...
            <div class="space-y-6">
                ...
                <div class="card">
                    <h2 class="heading-3 mb-4">Context</h2>
                    <dl class="grid sm:grid-cols-2 gap-y-3 gap-x-6 font-mono text-sm">
                        <dt class="text-ink-700">Design</dt>
                        <dd>
